...
mem load -i {C:\Modeltech_pe_edu_10.4a\examples\architecture-master/temp.mem} /microprocessor/fetchstageLabel/inst_mem/ram
...
add wave -position insertpoint  \
sim:/microprocessor/pushpopoutM
add wave -position insertpoint  \
